...
void DisplayDemo::runOption(const int index)
{
    ...
    std::cout << "Running Display method: " << key << std::endl;
    if (key == "Display.maxResolution")
    {
        ...
        if (validateResult(r))
        {
            ...
            std::cout << "Max Resolution - Width: " << res.width << ", Height: " << res.height << std::endl;
        }
    }
    else if (key == "Display.size")
    {
        ...
        if (validateResult(r))
        {
            ...
            std::cout << "Display Size - Width: " << size.width << ", Height: " << size.height << std::endl;
        }
    }
}
